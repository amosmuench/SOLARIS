...
tax_id<-snakemake@params[["tax_id"]]
...
mapped$Mapped_Percent=mapped$Mapped_Percent-mapped$Multimap_Percent-mapped$Multimap_Percent
...
db<-species_gene_goterm_universe_from_panther(tax_id)
